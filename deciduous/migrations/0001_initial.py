    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crown', models.CharField(blank=True, max_length=250, verbose_name='крона')),
                ...
                ('inflorescence', models.CharField(blank=True, max_length=250, verbose_name='соцветие')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='deciduous.decproduct', verbose_name='растение')),
        ...
        migrations.AddField(
            ...
            name='species',
            field=models.ForeignKey(help_text='Классификация растений: Отдел \\ Род \\ Вид. Пример: Хвойные \\ Ель \\ Ель канадская.', on_delete=django.db.models.deletion.CASCADE, to='deciduous.decspecies', verbose_name='вид'),
        ),
        migrations.AddIndex(
            model_name='decproduct',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='deciduous_d_search__bc0a59_gin'),
        ),
        migrations.AddIndex(
            model_name='decproduct',
            index=django.contrib.postgres.indexes.GinIndex(fields=['name'], name='trgm_decproduct_idx', opclasses=['gin_trgm_ops']),
        ),
    ]
