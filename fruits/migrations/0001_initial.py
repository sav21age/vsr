    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveSmallIntegerField(choices=[(1, '1-летка'), (2, '2-летка'), (3, '3-летка'), (4, '4-летка'), (5, '5-летка'), (6, '6-летка'), (7, '7-летка'), (8, '8-летка'), (9, '9-летка')], default=1, unique=True, verbose_name='возраст')),
            ],
            options={
